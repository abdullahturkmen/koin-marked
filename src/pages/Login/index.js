                ...
                <div className="container col-12 col-md-8 col-lg-6 col-xl-4 px-4 py-5">
                    <form className="py-4 form-template">
                            ...
                            <div className="col-12">
                                <div className="input-border">
                                    ...
                                    <input type="email" className="form-control
                                                                form-template-input" id="email" placeholder="address@example.com" defaultValue="" required=""/>
                                </div>
                            </div>
                            ...
                            <div className="col-12">
                                <div className="input-border">
                                    ...
                                    <input type="password" className="form-control
                                                                form-template-input" id="password" placeholder="•••••••" defaultValue="" required=""/>
                                </div>
                            </div>
                        ...
                        <button className="w-100 btn btn-md btn-primary
                                        rounded-pill px-5 py-3" type="submit">Login</button>
