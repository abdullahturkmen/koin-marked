...
const Home = () => {
    ...
    const [amountName, setAmountName] = useState('BTC');
    const [price, setPrice] = useState(1);
    const [priceName, setPriceName] = useState('USDT');
    ...
    useEffect(() => {
        ...
        axios.get(apiURL).then(response => {
            ...
            response.data.data.filter(e => e.name == "BTC").map(e => setPrice(e.price))
                                ...
                                <div className='input-content'>
                                    <div className="row my-4">
                                        ...
                                        <div className="col-5">
                                            <div className="input-border">
                                                <select onChange={
                                                        e => changeAmountName(e.target.value)
                                                    }
                                                    ref={amountRef}
                                    ...
                                    <div className="row my-4">
                                        ...
                                        <div className="col-5">
                                            <div className="input-border">
                                                <select onChange={
                                                        e => changePriceName(e.target.value)
                                                    }
                                                    ref={priceRef}
                                                    className="form-select
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            form-template-select"
