            ...
            <main className="container-fluid">
                ...
                <div className="container col-12 col-xl-10 p-4 bg-white shadow-light
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-lg-4 px-4 border-end">
                            <div className='d-flex justify-content-between'>
                            <h6 className='mb-0'>Trending</h6>
                            <a href="#" className='fs-6'><small>More</small></a>
                            </div>
                            <table className="table align-middle fs-6">
                                <thead>
                                    <tr>
                                        <td className='text-secondary'><small>Name</small></td>
                                        <td className='text-secondary'><small>Price</small></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <div className="col-7">
                                        <div className="input-border">
                                            ...
                                            <input type="text" className="form-control
                                                                                                                                                                                                                form-template-input text-end" id="amount" placeholder="5,000" defaultValue="5,000" required=""/>
                                        </div>
                                    </div>
                                ...
                                <div className="row my-4">
                                    <div className="col-7">
                                        <div className="input-border">
                                            ...
                                            <input type="text" className="form-control
                                                                                                                                                                                                                form-template-input text-end" id="get" placeholder="0.10901" defaultValue="0.10901" required=""/>
                                        </div>
                                    </div>
